...
var checkOutPrice = document.getElementById("CheckOut");
...
function displayTotal() {
    document.getElementById("total").innerHTML = "<br>Total order amount is R " + totalOrderAmt.toFixed(2);
}

function display_all() {
    var myTable = "<table><th style='width: 100px; color: red; textalignright;'>Num</th>";
